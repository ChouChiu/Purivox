...
def test_fifteen_minute_stereo_rss_length_and_seams(taps):
    ...
    try:
        ...
        block, _workers = _processing_layout(sample_rate, 8, frames, taps)
        ...
        print(f"15-minute benchmark peak RSS at taps={taps}: {peak_rss_kib / 1024:.1f} MiB")
